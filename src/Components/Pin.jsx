...
//   let alreadySave = save?.filter(
//     (item) => item?.postedBy?._id === userInfo?.sub
//   );

// alreadySave = alreadySave?.length > 0 ? alreadySave : []
...
//         {postHovered && (
//           <div
//             className="absolute top-0 w-full flex flex-col  h-full justify-between p-1 pr-2 pt-2 pb-2 z-50"
//             style={{ height: "100%" }}
//           >
...
//                         deletePin(_id);
//                       }}
//                       className="bg-white w-10 h-10 rounded-full flex justify-center text-dark items-center opacity-75 hover:opacity-100 hover:shadow-md outline-none text-xl"
//                     >
//                       <AiTwotoneDelete />
//                     </button>
//                   )}
...
//       <img className="w-8 h-8 rounded-full object-cover" src={postedBy?.image} alt="logo-profile"/>
